        ...
        <div style={{ display: 'flex', height: '100vh' }}>
            ...
            <div style={{ flex: 1, padding: '6%', background: '#fff' }}>
                ...
                >
                    ...
                    <button style={{ backgroundColor: '#233161', color: '#fff', borderRadius: '50px', padding: '10px 20px', alignSelf: 'start', margin: '2vh 0', border: 'none' }} onClick={handleLoginClick} >Ingresar</button>
                    <div style={{ marginTop: '4vh' }}></div>
                </div>
            </div>
        </div>
